...
from src.models.figconvnet.base_model import BaseModel
from src.models.figconvnet.components.encodings import SinusoidalEncoding
from src.models.figconvnet.components.mlp import MLP
...
from src.models.figconvnet.grid_feature_group import (
...
from src.models.figconvnet.point_feature_conv import (
    PointFeatureTransform,
)
from src.models.figconvnet.point_feature_grid_conv import (
    GridFeatureMemoryFormatConverter,
)
from src.models.figconvnet.point_feature_grid_ops import PointFeatureToGrid
...
class FIGConvUNet(BaseModel):
    ...
    def forward(
        ...
        # print(out_point_features.features.shape)
